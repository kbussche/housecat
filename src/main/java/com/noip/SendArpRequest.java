...
public class SendArpRequest {
  ...
  public static void getMac(String ip) throws PcapNativeException, NotOpenException {
    String strSrcIpAddress = "192.168.1.226"; // for InetAddress.getByName()
    String strDstIpAddress = ip; // for InetAddress.getByName()
